        ...
        <div className="grid grid-cols-1 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg leading-relaxed text-primary-foreground/80 max-w-md mb-10">
              Vi er her for å svare på alle dine spørsmål om VannFall og våre
              tjenester. Ingen forpliktelser – bare en god prat om mulighetene.
            </p>
          ...
          {/* <Card className="card-shadow-floating border-0">
            <CardContent className="p-8 sm:p-10">
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <Label htmlFor="name" className="form-label-vannfall">
                    Navn
                  </Label>
                  <Input
                    id="name"
                ...
                <div>
                  <Label htmlFor="email" className="form-label-vannfall">
                    E-post
                  </Label>
                  <Input
                    id="email"
                ...
                <div>
                  <Label htmlFor="phone" className="form-label-vannfall">
                    Telefon
                  </Label>
                  <Input
                    id="phone"
                ...
                <div>
                  <Label htmlFor="message" className="form-label-vannfall">
                    Melding
                  </Label>
                  <Textarea
                    id="message"
